...
public class MenFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_men2, container, false);
        menrecview = (RecyclerView)view.findViewById(R.id.menrecview);
        menrecview.setLayoutManager(new GridLayoutManager(getContext(),2));
        ...
        FirebaseRecyclerOptions<Product>options=
                new FirebaseRecyclerOptions.Builder<Product>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Products").orderByChild("category").equalTo("Men"),Product.class)
                        .build();

        adapter = new MenAdapter(options);
        menrecview.setAdapter(adapter);
