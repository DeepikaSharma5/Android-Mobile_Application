...
public class MenAdapter extends FirebaseRecyclerAdapter<Product,MenAdapter.homeviewholder> {



    public MenAdapter(@NonNull FirebaseRecyclerOptions<Product> options) {
        super(options);
    }
    ...
    protected void onBindViewHolder(@NonNull homeviewholder holder, int position, @NonNull final Product model) {
        ...
        holder.productImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                activity.getSupportFragmentManager().beginTransaction().replace(R.id.menActivity,new detailsfragment(model.getName(),model.getBrand(),model.getPrice(),model.getCategory(),model.getImage())).addToBackStack(null).commit();
            }
        });
    }
